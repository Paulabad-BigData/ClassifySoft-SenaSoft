...
$aux = 0;
$listar = null;
$directorio = opendir("C:\Users\juanj\Documents/Email files");
while ($elemento = readdir($directorio)) {

    if ($elemento != '.' && $elemento != '..' && substr($elemento, -4) == ".pdf") {
        if (is_dir("C:\Users\juanj\Documents/Email files" . $elemento)) {
            $listar .= "<li><a href='C:\Users\juanj\Documents/Email files/$elemento target='_blank'>$elemento/</a></li>";
        } else {
            $listar .= "<li><a href='C:\Users\juanj\Documents/Email files/$elemento target='_blank'>$elemento</a></li>";
        }

        $parseador = new \Smalot\PdfParser\Parser();
        $nombreDocumento = "C:\Users\juanj\Documents/Email files/$elemento";
        ...
        if (empty($texto)) {
            ...
            if (empty($imagenes)) {
                ...
                $destino = "C:\Users\juanj\Documents/Email files/Imagenes/$elemento";
            ...
            if ($pos === false) {
                ...
                $destino = "C:\Users\juanj\Documents\Email files/Cuentas de cobro/$elemento";
                copy($nombreDocumento, $destino) or die;
                unlink($nombreDocumento);
            ...
            if ($pos === false) {
                ...
                $destino = "C:\Users\juanj\Documents\Email files/Facturas/$elemento";
                copy($nombreDocumento, $destino) or die;
                unlink($nombreDocumento);
                $cont = 1;
                $cont2 = 1;
            ...
            if ($pos === false) {
                ...
                $destino = "C:\Users\juanj\Documents\Email files/Polizas/$elemento";
                copy($nombreDocumento, $destino) or die;
                unlink($nombreDocumento);
                $cont = 1;
                $cont2 = 1;
            ...
            if ($cont == 0) {
                ...
                $destino = "C:\Users\juanj\Documents\Email files/Varios/$elemento";
                copy($nombreDocumento, $destino) or die;
                unlink($nombreDocumento);
                $cont2 = 1;
